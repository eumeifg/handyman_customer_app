...
const APP_NAME = 'Sun3ah';
const APP_NAME_TAG_LINE = 'On-Demand Home Services App';
const DEFAULT_LANGUAGE = 'en';

const DOMAIN_URL = 'http://3.120.145.124';
const BASE_URL = '$DOMAIN_URL/api/';

/// You can change this to your Provider App package name
/// This will be used in Registered As Partner in Sign In Screen where your users can redirect to the Play/App Store for Provider App
/// You can specify in Admin Panel, These will be used if you don't specify in Admin Panel
const PROVIDER_PACKAGE_NAME = 'com.creativeadvtech.sunaah_customer';
const IOS_LINK_FOR_PARTNER = "https://apps.apple.com/in/app/handyman-provider-app/id";

const IOS_LINK_FOR_USER = 'https://apps.apple.com/us/app/handyman-service-user/id';
